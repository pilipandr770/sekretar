"""
Comprehensive integration tests for i18n functionality.
Tests end-to-end language switching, API integration, and template rendering.
"""
import pytest
...
class TestI18nTemplateIntegration:
    ...
    def test_template_globals_available(self, app):
        ...
        with app.test_request_context():
            ...
            assert 'get_available_languages' in globals_dict
            assert 'get_current_language' in globals_dict
            assert 'get_language_name' in globals_dict
            
            # Test the functions
            languages = globals_dict['get_available_languages']()
            assert languages == LANGUAGES
            
            current_lang = globals_dict['get_current_language']()
            assert current_lang in LANGUAGES
            
            lang_name = globals_dict['get_language_name']('de')
